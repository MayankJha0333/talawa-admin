...
// --------------------------------------------------------------------
export const UserConnectionListMock: IGQLMock[] = [
  {
    request: {
...
export const MESSAGE_SENT_TO_CHAT_MOCK: IGQLMock[] = [
  {
...
// --------------------------------------------------------------------
export const CHAT_BY_ID_QUERY_MOCK: IGQLMock[] = [
  {
...
export const UNREAD_CHAT_LIST_QUERY_MOCK: IGQLMock[] = [
  // No variables:
  {
...
export const GROUP_CHAT_BY_USER_ID_QUERY_MOCK: IGQLMock[] = [
  {
